...
describe( 'Function "moviesAverageByCategory"', () => {
 ...
 it( 'should return a number', () => {
  expect( typeof moviesAverageByCategory( 'Drama', movies ) ).toBe( 'number' );
 } );

 it( 'should return the correct average score for a category', () => {
  expect( moviesAverageByCategory( 'Drama', movies ) ).toBeCloseTo( 8.32, 2 ); // Ajusta este valor según tus datos
 } );

 it( 'should return the correct average score for a category', () => {
  expect( moviesAverageByCategory( 'Horror', movies ) ).toBeCloseTo( 8.34, 2 );
 } );
